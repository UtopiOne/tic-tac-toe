...
function checkArrayFullness(array: any[]) {
  let taken = 0;
...
function processGameData(e, cell: Element) {
...
UIBoard.forEach((cell) => {
  cell.addEventListener("mousedown", (e: Event) => processGameData(e, cell));
});
